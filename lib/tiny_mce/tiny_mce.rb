...
require File.dirname(__FILE__) + '/tiny_mce/base'
require File.dirname(__FILE__) + '/tiny_mce/exceptions'
require File.dirname(__FILE__) + '/tiny_mce/configuration'
require File.dirname(__FILE__) + '/tiny_mce/spell_checker'
require File.dirname(__FILE__) + '/tiny_mce/helpers'
...
if defined?(Rails::Railtie)
  require File.dirname(__FILE__) + '/tiny_mce/railtie'
else
  TinyMCE.initialize
end
